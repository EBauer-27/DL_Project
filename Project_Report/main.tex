...
\begin{document}
	...
	Table~\ref{tab:midas_results} summarizes the performance of the three implemented models. On the MIDAS datset, the TabTransformer achieves the best overall performance, with an AUC of $92\%$, indicating that the metadata contain highly informative features for the lesion classification. 
	...
	notes: FN to FN: multimodal model shifts often from the right lesion region to background
