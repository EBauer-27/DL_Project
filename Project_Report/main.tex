...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{Img/TP_to_TP_sprd762048797_comparison.png}
		\caption{Both models use a similar area of interest around the lesion. The multimodal has a higher confidence to predict the malignant due to metadata influence.}
		\label{fig:TP_to_TP}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{Img/FP_to_TN_sprd457711507_comparison.png}
		\caption{Both models use a similar area of interest around the lesion. The multimodal predicts the lesion correctly }
		\label{fig:grad_good}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{Img/FP_to_TN_sprd486848514_comparison.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{Img/TP_to_FN_sprd640509576_comparison.png}
		\caption{Good}
